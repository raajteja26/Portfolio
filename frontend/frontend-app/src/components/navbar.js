...
function navbar() {
  ...
  return (
        ...
        <Row>
        <Col style={{marginTop:"5px"}}><Navbar.Brand style={{fontWeight:"600px"}} href="/"><img src={favicon} style={{width:"25%",height:"60%"}} alt="R"/><span style={{fontWeight:"500"}}>aajteja.</span></Navbar.Brand></Col>
        <Col style={{marginTop:"5px"}}><Navbar.Brand style={{fontWeight:"600px"}} href="/projects">Projects</Navbar.Brand></Col>
