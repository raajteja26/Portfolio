...
from .models import Techincal_skills,Projects,Feedback,Certificates,Experience
from rest_framework import viewsets
from .serializers import ProjectsSerializer,SkillsSerializer,FeedbackSerializer,CertificatesSerializer,ExperienceSerializer
...
class ExperienceViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_serializer(self, *args, **kwargs):
        if isinstance(kwargs.get("data", {}), list):
            kwargs["many"] = True
        return super(ExperienceViewSet, self).get_serializer(*args, **kwargs)
